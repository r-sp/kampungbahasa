    ...
    <div className="px-4 py-8">
      <Prose className="mx-auto">
        ...
        <p>
          ...
          headings, lists and more. This ends up being really useful for building application
          UIs because you spend less time undoing user-agent styles, but when you{" "}
          <em>really are</em> just trying to style some content that came from a rich-text
        ...
        <p>
          ...
          <code>p</code> element in a piece of your dashboard UI. And I doubt you really want
        ...
        <pre>
          <code>
            ...
            eating garlic bread with cheese to their children, with the food earning such an
            iconic status in our culture that kids will often dress up as warm, cheesy loaf for
            Halloween. &lt;/p&gt; &lt;p&gt; But a recent study shows that the celebrated
            appetizer may be linked to a series of rabies cases springing up around the country.
            &lt;/p&gt; &lt;!-- ... --&gt; &lt;/article&gt;
          </code>
        </pre>
        <p>
        ...
        <p>
          ...
          the plugin itself. It includes every sensible typographic element I could think of,
          like <strong>bold text</strong>, unordered lists, ordered lists, code blocks, block
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              I explained what I'm doing already in the previous list item, but a list wouldn't
          ...
          <li>
            ...
            <p>
              ...
              things to type, I might as well include it. I'm going to press <kbd>Enter</kbd>{" "}
              now.
            </p>
          </li>
        </ul>
        ...
        <p>
          ...
          blocks but it wouldn't hurt to make them look <em>okay</em> out of the box, even with
        ...
        <ol>
          <li>
            ...
            <ul>
              <li>
                You might feel like you are being really "organized" or something but you are
                just creating a gross shape on the screen that is hard to read.
              </li>
              <li>
        ...
        <ul>
          ...
          <li>
            ...
            <ul>
              <li>
                <p>
                  As you can see here, because I've added a second line, this list item now has
                  a <code>&lt;p&gt;</code> tag.
                </p>
        ...
        <p>
          ...
          Medium only supports two heading levels for a reason, you animals. I honestly
        ...
        <p>
          Let's add a closing paragraph here so things end with a decently sized block of text.
          I can't explain why I want things to end that way but I have to assume it's because I
          think things will look weird or unbalanced if there is a heading too close to the end
          of the document.
        </p>
        <p>
        ...
        <p>
          <a href="https://tailwindcss-typography.vercel.app/">Tailwind CSS Typography</a>
        </p>
        <p>
