...
export default function HomePage() {
  return (
    <Prose className="px-4 py-6">
      ...
      <p>
        <strong>Self-recording</strong>: Listening to your own voice can help you identify areas
        for improvement.
      </p>
      <p>
      ...
      <p>
        <strong>Joining a conversation group</strong>: Practicing speaking with others can help
        you build confidence and improve your fluency.
      </p>
      <p>
