  ...
  return (
    ...
    >
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#blue-house-logo)",
      ...
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#green-buble-logo)",
          variant === "mono" && "currentColor",
        )}
      />
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#yellow-door-logo)",
          variant === "mono" && "currentColor",
        )}
      />
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#red-diamond-logo)",
          variant === "mono" && "currentColor",
        )}
      />
      {variant === "gradient" && (
  ...
  return (
    ...
    >
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#blue-house-banner)",
          variant === "mono" && "currentColor",
        )}
      />
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#green-buble-banner)",
          variant === "mono" && "currentColor",
        )}
      />
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#yellow-door-banner)",
          variant === "mono" && "currentColor",
        )}
      />
      <path
        ...
        fill={clsx(
          variant === "gradient" && "url(#red-diamond-banner)",
          variant === "mono" && "currentColor",
        )}
      />
      {variant === "gradient" && (
