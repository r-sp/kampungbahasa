...
export default function IconPerson({
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path d={clsx(outline ? iconOutlineHead : iconFillHead)} fill={color} fillRule="evenodd" clipRule="evenodd" />
      <path d={clsx(outline ? iconOutlineBody : iconFillBody)} fill={color} fillRule="evenodd" clipRule="evenodd" />
    </svg>
  );
}
