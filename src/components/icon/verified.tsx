...
export default function IconVerified({
  ...
  const iconSign = "M17.1364 9.63641L11 15.7728L7.36359 12.1364L8.63638 10.8636L11 13.2272L15.8636 8.36362L17.1364 9.63641Z";
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <defs>
        <linearGradient id="verified" x1="12" y1="1.79684" x2="12" y2="22.2032" gradientUnits="userSpaceOnUse">
