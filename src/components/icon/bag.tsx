...
export default function IconBag({
  ...
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path d={clsx(outline ? iconOutlineHandle : iconFillHandle)} fill={color} fillRule="evenodd" clipRule="evenodd" />
      <path d={clsx(outline ? iconOutlineBag : iconFillBag)} fill={color} fillRule="evenodd" clipRule="evenodd" />
    </svg>
  );
}
