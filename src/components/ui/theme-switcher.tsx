...
import { IconThemeContrast, IconThemeDark, IconThemeLight } from "../icon";

export default function ThemeSwitcher() {
  const { setThemeDark, setThemeLight, setThemeSystem, theme } = useStoreProvider((state) => state);
    ...
    <fieldset className="flex gap-1">
      ...
      <span className="inline-flex">
        <input
          ...
          className="sr-only"
        />
        <label htmlFor="theme-system" className={theme === "system" ? "text-slate-900" : "text-slate-600"}>
      ...
      <span className="inline-flex">
        <input
          ...
          className="sr-only"
        />
        <label htmlFor="theme-light" className={theme === "light" ? "text-slate-900" : "text-slate-600"}>
      ...
      <span className="inline-flex">
        <input
          ...
          className="sr-only"
        />
        <label htmlFor="theme-dark" className={theme === "dark" ? "text-slate-900" : "text-slate-600"}>
